...
genre=""
class Home():
    def __init__(self, app,name,screen_1):
        ...
        image_button1 = ctk.CTkButton(master=self.welcome_frame, text="Love", image=tk_image1,fg_color="#b7e8ed",hover_color="#C77C78",height=100,width=100)
        
        image2 = Image.open("icons\cool.png").resize((100,100))
        tk_image2 = ImageTk.PhotoImage(image2)
        image_button2 = ctk.CTkButton(master=self.welcome_frame, text="cool", image=tk_image2,fg_color="#b7e8ed",hover_color="#C77C78",height=100,width=100)
        
        image3 = Image.open("icons\History.png").resize((100,100))
        tk_image3 = ImageTk.PhotoImage(image3)
        image_button3 = ctk.CTkButton(master=self.welcome_frame, text="History", image=tk_image3,fg_color="#b7e8ed",hover_color="#C77C78",height=100,width=100)
        
        image4 = Image.open("icons\inspirational.png").resize((100,100))
        tk_image4 = ImageTk.PhotoImage(image4)
        image_button4 = ctk.CTkButton(master=self.welcome_frame, text="Inspirational", image=tk_image4,fg_color="#b7e8ed",hover_color="#C77C78",height=100,width=100)
        
        image5 = Image.open("icons\gratitude.png").resize((100,100))
        tk_image5 = ImageTk.PhotoImage(image5)
        image_button5 = ctk.CTkButton(master=self.welcome_frame, text="Gratitude", image=tk_image5,fg_color="#b7e8ed",hover_color="#C77C78",height=100,width=100)
        
        image6 = Image.open("icons\patience.png").resize((100,100))
        tk_image6 = ImageTk.PhotoImage(image6)
        image_button6 = ctk.CTkButton(master=self.welcome_frame, text="patience", image=tk_image6,fg_color="#b7e8ed",hover_color="#C77C78",height=100,width=100)

        image7 = Image.open("icons\life.png").resize((100,100))
        tk_image7 = ImageTk.PhotoImage(image7)
        image_button7 = ctk.CTkButton(master=self.welcome_frame, text="life", image=tk_image7,fg_color="#b7e8ed",hover_color="#C77C78",height=100,width=100)

        image8 = Image.open("icons\mindfulness.png").resize((100,100))
        tk_image8 = ImageTk.PhotoImage(image8)
        image_button8 = ctk.CTkButton(master=self.welcome_frame,text="mindfulness",image=tk_image8,fg_color="#b7e8ed",hover_color="#C77C78",height=100,width=100)
        ...
        self.label3 = ctk.CTkLabel(master=self.welcome_frame,
                                  text='Search By Genr2',font=("Arial", 20))
